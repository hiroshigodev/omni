...
We are currently in active development. Security updates are applied to the latest release on the `main` branch.
...
1. **Email us**: Send a detailed report to [EMAIL_ADDRESS](mailto:[EMAIL_ADDRESS]).
